...
public class ItemModelGen extends ItemModelProvider {
  ...
  public ItemModelGen(PackOutput output, ExistingFileHelper existingFileHelper) {
    super(output, GlobalConfig.MOD_ID, existingFileHelper);
  }
  ...
  protected void registerModels() {
    ...
    handheldItem(ItemsReg.COPPER_SWORD);
    handheldItem(ItemsReg.COPPER_PICKAXE);
    ...
    trimmedArmorItem(ItemsReg.COPPER_LEGGINGS);
    trimmedArmorItem(ItemsReg.COPPER_BOOTS);
  }
  
  private void handheldItem(DeferredItem<?> item) {
    this.withExistingParent(item.getId().getPath(),
        ResourceLocation.parse("item/handheld")).texture("layer0",
        ResourceLocation.fromNamespaceAndPath(GlobalConfig.MOD_ID, "item/" + item.getId().getPath()));
  }
  
  // Shoutout to El_Redstoniano for making this
  private void trimmedArmorItem(DeferredItem<ArmorItem> itemDeferredItem) {
    final String MOD_ID = GlobalConfig.MOD_ID; // Change this to your mod id
